...
(function(){
 ...
 if (/dlta=mog/.test(querystring)) {
  ...
  $("input[onClick='DoSaveAdd()']").val("  Do It  ");
  $("input[onClick='DoSaveAddAndAnother()']").val("  Do It Again  ");
  $("input[onClick='DoSaveCancel();']").val("  Don\'t Do It At All ");

  $("input[onClick='DoSaveAdd()']").attr("onClick","alert('Do It')");
  $("input[onClick='DoSaveAddAndAnother()']").attr("onClick","alert('Do It Again')");
  $("input[onClick='DoSaveCancel();']").attr("onClick",'alert("Don\'t Do It")');
